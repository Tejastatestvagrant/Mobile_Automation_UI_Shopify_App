...
export module MobileDriverUtil {
  ...
  export async function setupMobileDriver(
    ...
    try {
      ...
      else if (Constants.commandLineArguments.platform.includes('lambdatest') && Constants.commandLineArguments.os.includes('ios')) configJson.capabilities['lt:options'].name = specName;
