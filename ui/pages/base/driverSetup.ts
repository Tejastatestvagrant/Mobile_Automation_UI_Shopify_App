  ...
  export async function getMobileDriver(specName: string, platform?: EnvPropertiesEnums.Platform): Promise<Browser<'async'>> {
    ...
    switch (cloudPlatform) {
      case EnvPropertiesEnums.Platform.localApp:
        if (Constants.commandLineArguments.os !== undefined && Constants.commandLineArguments.os === 'ios') return MobileDriverUtil.setupMobileDriver(LocalConfigIos, specName, basicConfigEnvJson);
